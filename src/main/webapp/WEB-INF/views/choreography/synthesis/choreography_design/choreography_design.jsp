...
<%@include file="choreography_design_javascript.jsp"%>
...
<div class="row">
   <div class="col-md-12 col-sm-12 col-xs-12">
      ...
      <div class="x_panel">
         <div class="x_title">
            <h2>
               <spring:message code="choreography.design" />
            </h2>
            <ul class="nav navbar-right panel_toolbox">
               <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a></li>
            </ul>
                     ...
                     <div class="modal-body">
                        <div class="row">
                           ...
                           <div class="col-md-9 col-sm-12 col-xs-12">
                              <input type="text" id="cs-participant-name" name="cs-participant-name" data-parsley-participant_cs_exists="" data-parsley-trigger="focusout" required="required" class="form-control" />
                           </div>
                        </div>
                     </div>
                  ...
                  <div class="modal-content">
                     ...
                     <div class="modal-body">
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-9 col-sm-12 col-xs-12">
                              <input type="text" id="cs-state-name" name="cs-state-name" data-parsley-state_cs_exists="" data-parsley-trigger="focusout" required="required" class="form-control" />
                           </div>
                        </div>
                     </div>
                     <div class="modal-footer">
