               ...
               .ajax("${pageContext.request.contextPath}/choreography/coordinationdelegate/generate", {
                  ...
                  data: JSON.stringify({
                     "choreographySpecification" :{
                        "nodes": [{"id":"1","title":"s0","label":"s0","name":"s0","group":"sourceNode","type":"sourceNode","participant":null}],
                        "edges": [{"id":"1","from":"0ff646ea-0013-4404-a57f-59e94ba376c5","to":"b8ab0851-17fe-40dc-bb72-ab59d6a6164d","title":"(s0, p1, m1, p3, s1)","label":"m1 p1->p3","dashes":false,"type":"sendAction","message":"m1","participantSendMessage":"p1","participantReceiveMessage":"p3"}]},
                     "concreteParticipantsBehavior" :{
                        "nodes": [{"id":"2","title":"s0","label":"s0","name":"s0","group":"sourceNode","type":"sourceNode","participant":null}],
                        "edges": [{"id":"2","from":"0ff646ea-0013-4404-a57f-59e94ba376c5","to":"b8ab0851-17fe-40dc-bb72-ab59d6a6164d","title":"(s0, p1, m1, p3, s1)","label":"m1 p1->p3","dashes":false,"type":"sendAction","message":"m1","participantSendMessage":"p1","participantReceiveMessage":"p3"}]}
                  }),
                  dataType: 'json',
