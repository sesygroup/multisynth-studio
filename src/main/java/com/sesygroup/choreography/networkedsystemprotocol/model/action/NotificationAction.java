...
public class NotificationAction extends Action implements Serializable {
   private static final long serialVersionUID = -2869656044520878931L;
   ...
   public NotificationAction(final String operationName, final Set<InputParameter> inputParameters) {
      super(operationName);
   ...
   public String toString() {
      return ("<" + super.operationName + ", " + inputParameters.toString() + ", {}, required>")
