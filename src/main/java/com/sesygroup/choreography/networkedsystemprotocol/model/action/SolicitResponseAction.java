 ...
 * 
 * This operation is for a required interface.
 *
 */
public class SolicitResponseAction extends Action implements Serializable{
   private static final long serialVersionUID = 3979887007438141867L;
   private Set<InputParameter> inputParameters;
   private Set<OutputParameter> outputParameters;

   public SolicitResponseAction() {
      super();
      inputParameters = new HashSet<InputParameter>();
      outputParameters = new HashSet<OutputParameter>();
   }

   public SolicitResponseAction(final String name, final Set<InputParameter> inputParameters,
   ...
   public boolean equals(final Object obj) {
      ...
      SolicitResponseAction other = (SolicitResponseAction) obj;
   ...
   public String toString() {
      return ("<" + super.operationName + ", " + inputParameters.toString() + ", " + outputParameters.toString() + ", required>")
